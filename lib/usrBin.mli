...
val ls       : string ->
               ('a ->
                <Line| stat: <| mode: Line.present >;
                       source: Line.present > Line.t) Fitting.t
...
val from_directory : string ->
                     ('a -> <Line| source: Line.present > Line.t) Fitting.t
  (** Get the filenames in a directory.  Doesn't provide metadata. *)

val ps       : unit ->
                ('a -> 
                  <Line| ps: Line.present; 
                         seq: Line.present; 
                         source: Line.present > Line.t) Fitting.t
...
val cut      : ('a Line.t -> string) -> ('a Line.t -> 'a Line.t) Fitting.t
...
val echo : string -> ('a -> Line.empty Line.t) Fitting.t
  (** A fitting to print a string. *)

val renumber : int -> 
  (<Line| .. as 'a>  Line.t ->
     <Line| seq: Line.present; .. as 'a> Line.t) Fitting.t
...
val sort : ?compare:('a Line.t -> 'a Line.t -> int) -> unit ->
           ('a Line.t -> 'a Line.t) Fitting.t
...
val uniq : ?equal:('a Line.t -> 'a Line.t -> bool) -> unit ->
           ('a Line.t -> 'a Line.t) Fitting.t
...
val stat     : string -> 
               <Line| stat: <| mode: Line.present >; source: Line.present > Line.t
